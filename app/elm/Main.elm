...
import Html as H exposing (Html, a, button, code, div, h1, li, text, div, img, ul)
...
view model =
  div []
    [ h1 [] [ text "Links" ]
    , ul [] (List.map viewLink [ "/", "/en/about/", "/en/blog/", "/blog/42", "/en/blog/37", "/blog/?search=cats" ])
    , h1 [] [ text "History" ]
